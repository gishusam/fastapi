...
@pytest.fixture
def test_user123(client):
    user_data = {"email": "helloworld123@gmail.com", 
...
def test_user(client):
    user_data = {"email": "helloworld@gmail.com", 
                 "password": "password"}
    res = client.post("/users/", json = user_data)
    new_user = res.json()
    new_user['password'] = user_data['password']
...
@pytest.fixture
def test_post(test_user,session,test_user123):
    posts_data = [
        ...
        {"title": "Post 4", "content": "Content 4", "owner_id": test_user123['id']}
    ]
